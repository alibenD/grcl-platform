...
| SDK layering | [Language SDK Strategy](language-sdk-strategy.md) | [ADR-0003](../adr/ADR-0003-language-sdks-over-grcl-c.md), [ADR-0009](../adr/ADR-0009-language-sdk-binding-contract.md) | `src/grcl-cpp/include/grcl/cpp/*.hpp`, `src/grcl-cpp/tests/*.cpp`, `examples/cpp/*`, `src/grcl-py/grcl_py/*.py`, `scripts/check-sdk-boundaries.py` |
